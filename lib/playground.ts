...
export const PLAYGROUNDS: Record<SceneSlug, PlaygroundConfig> = {
  ...
  phyllotaxis: {
    defaults: { count: 520, speed: 1, spread: 3.2, environment: "dawn" },
    controls: [
      {
        kind: "slider",
        prop: "count",
  ...
  "strange-attractor": {
    defaults: { points: 6000, speed: 1, environment: "night" },
    controls: [
      {
        kind: "slider",
        prop: "points",
  ...
  boids: {
    defaults: { count: 170, speed: 1, environment: "night" },
    controls: [
      {
        kind: "slider",
        prop: "count",
  ...
  "curl-flow": {
    defaults: { count: 2400, speed: 1, size: 0.04, environment: "night" },
    controls: [
      {
        kind: "slider",
        prop: "count",
  ...
  cloth: {
    defaults: { segments: 26, speed: 1, wind: 1, environment: "studio" },
    controls: [
      {
        kind: "slider",
        prop: "segments",
  ...
  "voronoi-shatter": {
    defaults: { shards: 26, speed: 1, spread: 0.6, environment: "studio" },
    controls: [
      {
        kind: "slider",
        prop: "shards",
  ...
  tesseract: {
    defaults: { size: 1, speed: 1, thickness: 0.05, environment: "studio" },
    controls: [
      {
        kind: "slider",
        prop: "size",
  ...
  "pendulum-wave": {
    defaults: { count: 15, speed: 1, swing: 26, environment: "studio" },
    controls: [
      {
        kind: "slider",
        prop: "count",
  ...
  "pitch-momentum": {
    ...
    controls: [
      ...
      { kind: "color", prop: "colorA", label: "Team A" },
      { kind: "color", prop: "colorB", label: "Team B" },
      {
        kind: "select",
        prop: "environment",
        label: "Environment",
